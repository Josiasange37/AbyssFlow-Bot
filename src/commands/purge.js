...
module.exports = {
    ...
    async execute({ chatId, args, bot, message }) {
        try {
            ...
            await bot.sendMessage(chatId, { text: "🔍 Analyse de l'activité en cours... Ça peut prendre un moment bg. ⏳" }, { quoted: message });
            ...
            ghostList += `\n\n💡 _Utilise ton admin power pour faire le ménage mola ! 🧹_`;
