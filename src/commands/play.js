...
module.exports = {
  ...
  async execute({ chatId, args, bot, message }) {
    try {
      ...
      if (!query) {
        return await bot.sendMessage(chatId, { text: "Dis-moi quel son tu veux ! 🎧🔥\n\nEx: *play Burna Boy City Boys" }, { quoted: message });
      }
      ...
      await bot.sendMessage(chatId, { text: "Désolé , j'arrive pas à choper cette musique. Le serveur est peut-être saturé ! 💀" }, { quoted: message });
    }
  }
};
