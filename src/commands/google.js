...
module.exports = {
  ...
  execute: async ({ sock, chatId, message, args }) => {
    ...
    if (!query) return await bot.sendMessage(chatId, { text: "Dis-moi ce que tu cherches ! 🧐" }, { quoted: message });

    try {
      await bot.sendMessage(chatId, { text: "Attends , je fouille le web... 🔍🕸️" }, { quoted: message });
      ...
      await bot.sendMessage(chatId, { text: "J'ai rien trouvé de probant . T'as pas une question plus facile ? 🤨" }, { quoted: message });
