module.exports = {
  ...
  async execute({ chatId, message, bot }) {
    try {
      ...
      if (!mentioned) {
        return await bot.sendMessage(chatId, { text: "Mentionne celui que tu veux libérer ! 🕊️" }, { quoted: message });
      }
      ...
      if (bot.mutedUsers && bot.mutedUsers.has(chatId)) {
        ...
        await bot.sendMessage(chatId, { text: "Ce gars n'est même pas mute . 😂" });
      }
